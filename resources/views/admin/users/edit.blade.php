                        ...
                        <div class="card-body custom-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control custom-input" name="description" id="description" rows="5" style="resize: none; height: auto">{{ $user->description }}</textarea>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            @include('admin.includes.image-uploader', [
                                ...
                                'currentImage' => !empty($user->image) ? asset($user->image) : null,
