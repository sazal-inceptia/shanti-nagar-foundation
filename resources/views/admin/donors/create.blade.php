                    ...
                    <div class="card table-card mb-4">
                        <div class="card-header table-header">
                            <div class="title-with-breadcrumb">
                                <div class="table-title">New Donor Profile</div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-8 col-12">
                                    ...
                                    <input type="text" class="form-control custom-input @error('name') is-invalid @enderror"
                                        name="name" id="name" value="{{ old('name') }}" placeholder="e.g. Alhaj Noor Mohammad" required>
                                    @error('name')
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <select class="form-select custom-input @error('donor_type') is-invalid @enderror" name="donor_type" id="donor_type" required>
                                        @foreach($donorTypes as $typeKey => $typeLabel)
                                            <option value="{{ $typeKey }}" {{ old('donor_type') == $typeKey ? 'selected' : '' }}>
                                                {{ $typeLabel }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="email" class="form-control custom-input @error('email') is-invalid @enderror"
                                        name="email" id="email" value="{{ old('email') }}" placeholder="e.g. donor@example.com">
                                    @error('email')
                                        <div class="error_msg text-danger mt-1" style="font-size: 12px;">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control custom-input @error('city') is-invalid @enderror"
                                        name="city" id="city" value="{{ old('city', 'Dhaka') }}" placeholder="e.g. Dhaka">
                                    @error('city')
                                        <div class="error_msg text-danger mt-1" style="font-size: 12px;">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control custom-input @error('country') is-invalid @enderror"
                                        name="country" id="country" value="{{ old('country', 'Bangladesh') }}" placeholder="e.g. Bangladesh">
                                    @error('country')
                                        <div class="error_msg text-danger mt-1" style="font-size: 12px;">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control custom-input @error('address') is-invalid @enderror"
                                        name="address" id="address" value="{{ old('address') }}" placeholder="e.g. House 22, Road 5, Shanti Nagar, Dhaka">
                                    @error('address')
                                        <div class="error_msg text-danger mt-1" style="font-size: 12px;">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control custom-input @error('notes') is-invalid @enderror"
                                        name="notes" id="notes" rows="4" placeholder="Regular monthly contributor, Zakat donor, specific project preference...">{{ old('notes') }}</textarea>
                                    @error('notes')
                                        <div class="error_msg text-danger mt-1" style="font-size: 12px;">{{ $message }}</div>
                                    @enderror
                                </div>
