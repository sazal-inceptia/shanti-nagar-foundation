                                ...
                                <div class="col-md-8 col-12">
                                    <div class="d-flex align-items-center justify-content-between mb-1">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <a href="{{ route('article-categories.index') }}" target="_blank" class="text-decoration-none text-muted" style="font-size: 12px; font-weight: 500;" title="Manage Categories in full view">
                                                <i class="ri-settings-3-line text-primary me-1"></i>Manage Categories
                                            </a>
                                            @canany(['article-category-create', 'blog-create'])
                                                <button type="button" class="btn btn-sm btn-outline-primary d-inline-flex align-items-center justify-content-center p-0 rounded-circle" style="width: 22px; height: 22px; border-width: 1.5px;" title="Quick Add Category" data-bs-toggle="modal" data-bs-target="#quickCategoryModal">
                                    ...
                                    <div class="d-flex flex-column gap-3 mb-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="datetime-local" class="form-control custom-input"
                                                ...
                                                value="{{ old('published_at', now()->format('Y-m-d\TH:i')) }}" onclick="this.showPicker()">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 12px; overflow: hidden;">
                <div class="modal-header border-bottom py-3 px-4" style="background-color: #f8fafc;">
                    <div class="d-flex align-items-center gap-2">
                        <div class="d-flex align-items-center justify-content-center rounded" style="width: 32px; height: 32px; background-color: #fff3ee; color: #f95716;">
                            <i class="ri-price-tag-3-line" style="font-size: 17px;"></i>
                        </div>
                        <div>
                            <h6 class="modal-title fw-bold text-dark mb-0" id="quickCategoryModalLabel" style="font-size: 15px;">Add Article Category</h6>
                ...
                <form id="quickCategoryForm">
                    ...
                    <div class="modal-body p-4">
                        <div class="mb-3">
                            <label for="quick_category_name" class="form-label custom-label required">Category Name <span class="text-danger">*</span></label>
                            <input type="text" class="form-control custom-input" id="quick_category_name" name="name" required placeholder="e.g. Sustainable Architecture, Civil Engineering">
                            <div class="invalid-feedback" id="quick_category_name_error"></div>
                        </div>
                        <div class="mb-2">
                            <label for="quick_category_description" class="form-label custom-label">Description <span class="text-muted fw-normal">(Optional)</span></label>
                            <textarea class="form-control custom-input" id="quick_category_description" name="description" rows="3" placeholder="Brief description of articles in this category..."></textarea>
                            <div class="invalid-feedback" id="quick_category_description_error"></div>
                        </div>
                    </div>
                    <div class="modal-footer border-top py-2 px-4 d-flex justify-content-between" style="background-color: #f8fafc;">
                        <a href="{{ route('article-categories.index') }}" target="_blank" class="text-primary text-decoration-none fw-semibold" style="font-size: 12.5px;">
                            <i class="ri-external-link-line me-1"></i>Manage Categories
                        </a>
                        <div class="d-flex align-items-center gap-2">
                            <button type="button" class="btn btn-sm btn-light border" data-bs-dismiss="modal" style="font-size: 13px; font-weight: 500; padding: 6px 14px; border-radius: 6px;">Cancel</button>
                            <button type="submit" id="btnSaveQuickCategory" class="btn btn-sm text-white" style="background-color: #f95716; border-color: #f95716; font-size: 13px; font-weight: 600; padding: 6px 16px; border-radius: 6px;">
                                <span class="spinner-border spinner-border-sm me-1 d-none" id="saveCategorySpinner" role="status"></span>
