...
@section('content')
    <div class="container-fluid my-3">
        <form id="teamMemberCreateForm" action="{{ route('team-members.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
            @csrf
            <div class="row">
                    ...
                    <div class="card table-card mb-4">
                        <div class="card-header table-header">
                            <div class="title-with-breadcrumb">
                                <div class="table-title">New Team Member Profile</div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control custom-input @error('name') is-invalid @enderror"
                                        name="name" id="name" value="{{ old('name') }}" placeholder="e.g. Harry Son" required>
                                    @error('name')
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control custom-input @error('designation') is-invalid @enderror"
                                        name="designation" id="designation" value="{{ old('designation') }}" placeholder="e.g. Senior Project Architect" required>
                                    @error('designation')
                                        <div class="error_msg">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="text" list="departmentList" class="form-control custom-input @error('department') is-invalid @enderror"
                                        name="department" id="department" value="{{ old('department') }}" placeholder="e.g. Architecture & Planning, Structural">
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="email" class="form-control custom-input @error('email') is-invalid @enderror"
                                        name="email" id="email" value="{{ old('email') }}" placeholder="name@company.com">
                                    @error('email')
                                        <div class="error_msg">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control custom-input @error('phone') is-invalid @enderror"
                                        name="phone" id="phone" value="{{ old('phone') }}" placeholder="+1 (555) 000-0000">
                                    @error('phone')
                                        <div class="error_msg">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control custom-input @error('bio') is-invalid @enderror"
                                        ...
                                        placeholder="Engineering credentials, leadership background, certifications, and architectural specializations...">{{ old('bio') }}</textarea>
                                    @error('bio')
                                        <div class="error_msg">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="d-flex flex-column gap-3 mb-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="is_active" id="is_active"
                                                value="1" {{ old('is_active', '1') ? 'checked' : '' }} style="cursor: pointer;">
                                        ...
                                        <div>
                                            ...
                                            <input type="number" class="form-control custom-input @error('sort_order') is-invalid @enderror"
                                                name="sort_order" id="sort_order" value="{{ old('sort_order', $nextSortOrder) }}" min="0">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-6">
                                            <button type="submit" class="btn submit-button w-100">
                                                <i class="ri-check-line me-1"></i> Save Member
                                            </button>
                                        </div>
                                        <div class="col-6">
