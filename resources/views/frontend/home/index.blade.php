...
@section('content')
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="image-layer"
                            style="background-image: url({{ asset('assets/images/banner/banner-1.jpg') }});">
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer"
                            style="background-image: url({{ asset('assets/images/banner/banner-3.jpg') }});">
                        </div>
                        <div class="auto-container">
                            <div class="content-box">
                                <h2>Help Today</h2>
                    ...
                    <div class="image_block_1">
                        <div class="image-box">
                            <figure class="image image-1"><img
                                    src="{{ asset('assets/images/resource/about-1.png') }}"
                                    alt=""></figure>
                            <figure class="image image-2"><img
                                    src="{{ asset('assets/images/resource/about-2.png') }}"
                                    alt=""></figure>
                            <figure class="image image-3"><img
                                    src="{{ asset('assets/images/icons/heart-2.png') }}" alt="">
                            </figure>
                            <figure class="image image-4"><img
                                    src="{{ asset('assets/images/icons/heart-3.png') }}" alt="">
                            </figure>
                            <figure class="image image-5"><img
                                    src="{{ asset('assets/images/icons/imoji-1.png') }}" alt="">
                            </figure>
                            <div class="text">
    ...
    <!-- urgent-case-section -->
    <section class="urgent-case-section"
                ...
                <div class="row clearfix">
                    <div class="col-xl-6 col-lg-12 col-md-12 offset-xl-6">
                        <div class="urgent-case-block">
                            <div class="upper-box"
                                style="background-image: url({{ asset('assets/images/background/4.jpg') }});">
                            ...
                            <div class="tab active-tab" id="tab-1">
                                <div class="three-item-carousel owl-carousel owl-theme owl-dots-none">
                                    <div class="case-block-one">
                                        <div class="inner-box">
                                            <figure class="image-box"><img
                                                    src="{{ asset('assets/images/case/case-1.jpg') }}"
                                                    alt=""></figure>
                                            <div class="lower-content">
                                                <div class="shape"
                                                    style="background-image: url({{ asset('assets/images/shape/shape-11.png') }});">
                                                </div>
                                    ...
                                    <div class="case-block-one">
                                        <div class="inner-box">
                                            <figure class="image-box"><img
                                                    src="{{ asset('assets/images/case/case-2.jpg') }}"
                                                    alt=""></figure>
                                            <div class="lower-content">
                                                <div class="shape"
                                                    style="background-image: url({{ asset('assets/images/shape/shape-11.png') }});">
                                    ...
                                    <div class="case-block-one">
                                        <div class="inner-box">
                                            <figure class="image-box"><img
                                                    src="{{ asset('assets/images/case/case-3.jpg') }}"
                                                    alt=""></figure>
                                            <div class="lower-content">
                                                <div class="shape"
                                                    style="background-image: url({{ asset('assets/images/shape/shape-11.png') }});">
    ...
    <section class="recent-case-section">
        <div class="bg-layer"
            style="background-image: url({{ asset('assets/images/background/5.jpg') }});"></div>
        <div class="pattern-layer"
        ...
        <div class="auto-container">
            <div class="inner-box">
                <div class="shape"
                    style="background-image: url({{ asset('assets/images/shape/shape-21.png') }});">
                </div>
                <div class="inner">
                    <div class="sec-title centred light">
                        <span class="top-text">Recent Donors</span>
                        <h2>Thousands of Donors Choose Shanti Nagar Foundation <br />for High Impact Causes</h2>
                    </div>
                    <div class="single-item-carousel owl-carousel owl-theme owl-dots-none">
                        <div class="single-item">
                            <figure class="image-box"><img
                                    src="{{ asset('assets/images/resource/thumb-1.png') }}"
                                    alt=""></figure>
                            <div class="text">
                        ...
                        <div class="single-item">
                            <figure class="image-box"><img
                                    src="{{ asset('assets/images/resource/thumb-2.png') }}"
                                    alt=""></figure>
                            <div class="text">
                                <h3>Jasper Flelix, <span>Liverpool</span></h3>
                                <h6>Donated $250</h6>
                        ...
                        <div class="single-item">
                            <figure class="image-box"><img
                                    src="{{ asset('assets/images/resource/thumb-3.png') }}"
                                    alt=""></figure>
                            <div class="text">
                                <h3>Jasper Flelix, <span>Liverpool</span></h3>
                                <h6>Donated $250</h6>
                        ...
                        <div class="single-item">
                            <figure class="image-box"><img
                                    src="{{ asset('assets/images/resource/thumb-4.png') }}"
                                    alt=""></figure>
                            <div class="text">
                                <h3>Jasper Flelix, <span>Liverpool</span></h3>
                                <h6>Donated $250</h6>
                        ...
                        <div class="single-item">
                            <figure class="image-box"><img
                                    src="{{ asset('assets/images/resource/thumb-5.png') }}"
                                    alt=""></figure>
                            <div class="text">
                                <h3>Jasper Flelix, <span>Liverpool</span></h3>
                                <h6>Donated $250</h6>
                        ...
                        <div class="single-item">
                            <figure class="image-box"><img
                                    src="{{ asset('assets/images/resource/thumb-6.png') }}"
                                    alt=""></figure>
                            <div class="text">
                                <h3>Jasper Flelix, <span>Liverpool</span></h3>
                                <h6>Donated $250</h6>
                        ...
                        <div class="single-item">
                            <figure class="image-box"><img
                                    src="{{ asset('assets/images/resource/thumb-7.png') }}"
                                    alt=""></figure>
                            <div class="text">
                                <h3>Jasper Flelix, <span>Liverpool</span></h3>
                                <h6>Donated $250</h6>
    ...
    <section class="benefits-section">
        <div class="pattern-layer"
            style="background-image: url({{ asset('assets/images/shape/shape-15.png') }});">
        </div>
        <div class="auto-container">
            <div class="row clearfix">
                <div class="col-lg-4 col-md-12 col-sm-12 title-column">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                                <div class="single-item">
                                    ...
                                    <div class="icon-box">
                                        <div class="shape"
                                            style="background-image: url({{ asset('assets/images/shape/shape-13.png') }});">
                                        </div>
                                        <div class="shape-2"
                                            style="background-image: url({{ asset('assets/images/shape/shape-14.png') }});">
                                        </div>
    ...
    <section class="video-section"
        style="background-image: url({{ asset('assets/images/background/6.jpg') }});">
        <div class="auto-container">
            <div class="video-carousel owl-carousel owl-theme owl-dots-none">
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                        <figure class="image-box"><img
                                src="{{ asset('assets/images/resource/video-1.jpg') }}" alt="">
                        </figure>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 content-column">
                        <div class="content-box">
                            ...
                            <div class="video-btn">
                                <div class="shape"
                                    style="background-image: url({{ asset('assets/images/shape/shape-16.png') }});">
                                </div>
    ...
    <section class="events-section">
        <div class="pattern-layer"
            style="background-image: url({{ asset('assets/images/shape/shape-17.png') }});">
        </div>
        <div class="bg-layer"
            style="background-image: url({{ asset('assets/images/background/7.jpg') }});"></div>
        <div class="auto-container">
            <div class="inner-container">
                <div class="shape"
                    style="background-image: url({{ asset('assets/images/shape/shape-18.png') }});">
                </div>
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 inner-column">
                        <div class="right-column">
                            <div class="events-block-one wow fadeInRight animated" data-wow-delay="00ms"
                                ...
                                <div class="inner-box">
                                    <div class="shape"
                                        style="background-image: url({{ asset('assets/images/shape/shape-20.png') }});">
                                    </div>
                                    <figure class="image-box">
                                        <img src="{{ asset('assets/images/events/events-1.jpg') }}"
                                            alt="">
                            ...
                            <div class="events-block-one wow fadeInRight animated" data-wow-delay="100ms"
                                ...
                                <div class="inner-box">
                                    ...
                                    <figure class="image-box">
                                        <img src="{{ asset('assets/images/events/events-2.jpg') }}"
                                            alt="">
                            ...
                            <div class="events-block-one wow fadeInRight animated" data-wow-delay="200ms"
                                ...
                                <div class="inner-box">
                                    ...
                                    <figure class="image-box">
                                        <img src="{{ asset('assets/images/events/events-3.jpg') }}"
                                            alt="">
    ...
    <section class="team-section centred">
        <div class="pattern-layer"
            style="background-image: url({{ asset('assets/images/shape/shape-23.png') }});">
        </div>
        <div class="auto-container">
            <div class="sec-title centred">
                <span class="top-text">Meet Our Team</span>
                <h2>Most Passionate Team Members</h2>
                <p>The master-builder of human happiness no one rejects, dislikes <br />or avoids pleasure itself pleasure,
                </p>
            </div>
            <div class="four-item-carousel owl-carousel owl-theme owl-nav-none">
                <div class="team-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img
                                src="{{ asset('assets/images/team/team-1.jpg') }}" alt="">
                        </figure>
                        <div class="content-box">
                            <div class="info">
                            ...
                            <figure class="thumb-box"><img
                                    src="{{ asset('assets/images/team/team-1.png') }}" alt="">
                            </figure>
                            <div class="text">
                ...
                <div class="team-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img
                                src="{{ asset('assets/images/team/team-2.jpg') }}" alt="">
                        </figure>
                        <div class="content-box">
                            <div class="info">
                            ...
                            <figure class="thumb-box"><img
                                    src="{{ asset('assets/images/team/team-2.png') }}" alt="">
                            </figure>
                            <div class="text">
                                <p>He rejects pleasures to secure other greater pleasures or else he endures.</p>
                            </div>
                ...
                <div class="team-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img
                                src="{{ asset('assets/images/team/team-3.jpg') }}" alt="">
                        </figure>
                        <div class="content-box">
                            <div class="info">
                            ...
                            <figure class="thumb-box"><img
                                    src="{{ asset('assets/images/team/team-3.png') }}" alt="">
                            </figure>
                            <div class="text">
                                <p>He rejects pleasures to secure other greater pleasures or else he endures.</p>
                            </div>
                ...
                <div class="team-block-one">
                    <div class="inner-box">
                        <figure class="image-box"><img
                                src="{{ asset('assets/images/team/team-4.jpg') }}" alt="">
                        </figure>
                        <div class="content-box">
                            <div class="info">
                            ...
                            <figure class="thumb-box"><img
                                    src="{{ asset('assets/images/team/team-4.png') }}" alt="">
                            </figure>
                            <div class="text">
                                <p>He rejects pleasures to secure other greater pleasures or else he endures.</p>
                            </div>
    ...
    <section class="testimonial-section">
        <div class="pattern-layer"
            style="background-image: url({{ asset('assets/images/shape/shape-24.png') }});">
        </div>
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 inner-column">
                    <div class="inner-box">
                        <figure class="image-box"><img
                                src="{{ asset('assets/images/resource/testimonial-1.jpg') }}"
                                alt=""></figure>
                            ...
                            <div class="single-item-carousel owl-carousel owl-theme owl-dots-none">
                                <div class="testimonial-block-one">
                                    <div class="text">
                                        ...
                                        <p>Shanti Nagar Foundation! charities provided jump start we needed to expaand our all efforts
                                    ...
                                    <figure class="testimonial-thumb"><img
                                            src="{{ asset('assets/images/resource/testimonial-thumb-1.png') }}"
                                            alt=""></figure>
                                </div>
                                <div class="testimonial-block-one">
                                    <div class="text">
